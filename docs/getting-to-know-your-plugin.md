...
![Account Screen]({{'/images/account_screen.png' | relative_url }}) | ![Password Log-in Screen]({{ '/images/login_screen.png' | relative_url }})
:---:|:---:
...
![Landing Explainer Screen]({{ '/images/signup_information.png' | relative_url }})
...
![Login Details Screen]({{ '/images/login_details.png' | relative_url }})
...
![Empty Eligibility Form]({{ '/images/signup_eligibility-empty.png' | relative_url }}) | ![Prefilled Eligibility Form]({{ '/images/signup_eligibility-prefilled.png' | relative_url }}) | ![Hidden Fields Eligibility Form]({{ '/images/signup_eligibility-hidden.png' | relative_url }})
:---:|:---:|:---:
...
![Personal Details Form]({{ '/images/signup_personal-form.png' | relative_url }}) | ![Contact Details Form]({{ '/images/signup_contact-form.png' | relative_url }})

Personal or contact detail forms are show with fields disabled when data provided by token payload.

![Personal Details Preview]({{ '/images/signup_personal-preview.png' | relative_url }}) | ![Contact Details Preview]({{ '/images/signup_contact-preview.png' | relative_url }})
...
![Bank Details Screen]({{ '/images/signup_bank-details.png' | relative_url }})
...
![Documents Screen - Not Viewed]({{ '/images/signup_documents-notviewed.png' | relative_url }}) | ![Documents Screen - Viewed]({{ '/images/signup_documents-viewed.png' | relative_url }})
...
![Pending Status]({{ '/images/signup_idv-pending.png' | relative_url }})
...
![Escalated Status]({{ '/images/signup_idv-escalated.png' | relative_url }}) | ![Rejected Status]({{ '/images/signup_idv-rejected.png' | relative_url }})
:---:|:---:
...
![Sign up Complete]({{ '/images/signup_complete.png' | relative_url }})
