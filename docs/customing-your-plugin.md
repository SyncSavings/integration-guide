...
![Bullet Icons and Graphic base colour on the Landing Explainer Screen]({{ '/images/signup_information.png' | relative_url }})

Bullet Icons and Graphic base colour on the Landing Explainer Screen

![Border of a selected Card and the Progress Stepper (Breadcrumbs)]({{ '/images/customising_card-stepper.png' | relative_url }})

Border of a selected Card and the Progress Stepper (Breadcrumbs)

![Onboarding Complete screen’s NextSteps, Dashboard’s NextDeposit graphic and Transactions Item’s highlight text]({{ '/images/customising_nextsteps-nextdeposit-highlight.png' | relative_url }})
...
![Default]({{ '/images/buttons_default.png' | relative_url }}) | ![**`Button`** set to a dark purple and **`useDarkButtonText`** left empty]({{ '/images/buttons_dark-purple.png' | relative_url }}) | ![**`Button`**  set to a light purple and **`useDarkButtonText`** set to **`YES`**]({{ '/images/buttons_light-purple.png' | relative_url }})
:--------------------------------:|:--------------------------------------------------------------------------------------------------:|:-------------------------------------:
...
![image.png]({{ '/images/customising_block-account.png' | relative_url }})

**2. Sync’s Built-in gradients**

![image.png]({{ '/images/customising_gradient-account.png' | relative_url }})
...
Right - **`Pot`** set to pink and **`useLightCategoryFont`** left empty]({{ '/images/customising_brand-account.png' | relative_url }})
...
Right - **`Card`** set to a dark purple and **`UseCardLightText`** set to **`YES`**]({{ '/images/customising_card.png' | relative_url }})
...
![image.png]({{ '/images/signup_information.png' | relative_url }})
